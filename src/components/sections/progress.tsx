    ...
    <section id="progress" className="relative px-4 py-24 md:py-32">
      <div className="mx-auto max-w-5xl">
        ...
        <SectionReveal delay={0.1} className="mb-8">
          <div className="rounded-xl border border-green-500/20 bg-zinc-950/50 p-6">
        ...
        <StaggerContainer className="grid grid-cols-1 gap-4 md:grid-cols-2" staggerDelay={0.08}>
          {weeklyProgress.projects.map((project) => (
            <StaggerItem key={project.title}>
              <div className="rounded-xl border border-white/[0.06] bg-zinc-950/50 p-5 transition-colors hover:border-white/[0.12]">
